...
DEM_PATH = os.path.join(BASE_DIR, "Miami", "Miami.dem")  # Ensure correct casing

def plot_miami_dem(sea_level):
    """
    ...
    with rasterio.open(DEM_PATH) as src:
        ...
        ax.set_title(f"Miami DEM with {sea_level:.2f}m Sea Level Rise")

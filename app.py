...
def emissions_ui():
    ...
    co2 = st.sidebar.slider(
        "Cumulative CO2 Emitted (GtCO2) by 2100", 0, max_co2, 4520, 10
    )
    return co2
...
def main():
    ...
    st.markdown("*We have three sections of the app. The first two are educational. They aim to help you understand our methods and help you visualize sea level rise in isolation. The boxplot and the map at the bottom of the page react with the cumulative carbon dioxide and emulator selection. To skip the first two sections, please click the words below:*")
